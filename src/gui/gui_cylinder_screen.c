...
/*   Updated: 2020/02/19 19:51:35 by sleonia          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	gui_cylinder_screen(t_sdl *sdl, t_object **hi_lited_object)
{
	...
	sdl_putstr((SDL_Rect){50, 250, 0, 0}, "radius", sdl->gui->ttf[BIG_FONT_ID], sdl->screen[1]->sur);
	sdl_putstr((SDL_Rect){360, 100, 0, 0}, "axis", sdl->gui->ttf[BIG_FONT_ID], sdl->screen[1]->sur);
	sdl_putstr((SDL_Rect){360, 250, 0, 0}, "center", sdl->gui->ttf[BIG_FONT_ID], sdl->screen[1]->sur);
